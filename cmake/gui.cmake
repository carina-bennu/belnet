...
elseif(WIN32)
  ...
  set(GUI_EXE "" CACHE FILEPATH "path to an externally built belnet gui.exe")
endif()
...
if (BUILD_GUI)
  ...
  elseif(WIN32)
    ...
    if(GUI_ZIP_FILE)
      ...
      add_custom_target("${PROJECT_BINARY_DIR}/gui/belnet-gui.exe" COMMAND "true")
    elseif(GUI_EXE)
      message(STATUS "using custom belnet gui executable: ${GUI_EXE}")
