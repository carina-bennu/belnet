...
namespace llarp
{
  ...
  Config_Init(py::module& mod)
  {
    ...
    py::class_<Config, Config_ptr>(mod, "Config")
        ...
        .def_readwrite("beldexd", &Config::beldexd)
    ...
    py::class_<NetworkConfig>(mod, "NetworkConfig")
        ...
        .def_readwrite("mnodeBlacklist", &NetworkConfig::m_mnodeBlacklist)
    ...
    py::class_<BeldexdConfig>(mod, "BeldexdConfig")
        .def(py::init<>())
        .def_readwrite("whitelistRouters", &BeldexdConfig::whitelistRouters)
        .def_readwrite("ident_keyfile", &BeldexdConfig::ident_keyfile)
        .def_property(
            "beldexdRPCAddr",
