  ...
  LinksConfig::defineConfigOptions(ConfigDefinition& conf, const ConfigGenParameters& params)
  {
    ...
    conf.defineOption<std::string>(
        ...
        Comment{
            ...
            "public IP address and use that IP. If port is omitted then belnet defaults to 1090.",
            "",
            "Examples:",
    ...
    conf.defineOption<std::string>(
        ...
        Comment{
            ...
            "",
            "If no outbound bind IP is configured then belnet will use a wildcard address to use",
