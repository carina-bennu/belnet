...
namespace llarp
{
  ...
  namespace service
  {
    ...
    using MNodeSessions = std::unordered_map<RouterID, std::shared_ptr<exit::BaseSession>>;
    ...
    using BNSNameCache = std::unordered_map<std::string, std::pair<Address, llarp_time_t>>;
